(function($) {
  $.declare('slide', {
    defaults: {
      ...
      nextLabel: 'Next',
      prevLabel: 'Prev',
      itemWidth: 500 // Only used for container generation
    },
    ...
    createContainer: function() {
      ...
      this.el.append('<' + this.buttonEl + ' data-action="previous">' + this.prevLabel + '</' + this.buttonEl + '>');
      this.el.append('<' + this.buttonEl + ' data-action="next">' + this.nextLabel + '</' + this.buttonEl + '>');
      ...
      this.el.find('.' + this.itemClass).css({
        'float': 'left',
