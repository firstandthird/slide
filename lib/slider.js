(function($) {
  $.declare('slider', {
    ...
    _slideCSS: function(direction, cb) {
      ...
      $(self.items).one('animationend webkitAnimationEnd oAnimationEnd MSAnimationEnd', function(){
      ...
      $(this.items[this.currentPage - 1]).addClass(direction + 'ItemAnimationIn');
      ...
      $(this.items[out]).addClass(direction + 'ItemAnimationOut');
    },
